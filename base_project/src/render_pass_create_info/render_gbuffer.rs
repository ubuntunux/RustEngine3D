...
pub fn get_framebuffer_data_create_info(renderer: &Renderer) -> FramebufferDataCreateInfo {
    framebuffer::create_framebuffer_data_create_info(
        &[
            RenderTargetInfo {
                _texture_data: renderer.get_render_target(RenderTargetType::SceneAlbedo),
                _target_layer: 0,
                _target_mip_level: 0,
                _clear_value: Some(vulkan_context::get_color_clear_zero()),
            },
            RenderTargetInfo {
                _texture_data: renderer.get_render_target(RenderTargetType::SceneMaterial),
                _target_layer: 0,
                _target_mip_level: 0,
                _clear_value: Some(vulkan_context::get_color_clear_zero()),
            },
            RenderTargetInfo {
                _texture_data: renderer.get_render_target(RenderTargetType::SceneNormal),
                _target_layer: 0,
                _target_mip_level: 0,
                _clear_value: Some(vulkan_context::get_color_clear_value(0.5, 0.5, 1.0, 0.0)),
            },
            RenderTargetInfo {
                _texture_data: renderer.get_render_target(RenderTargetType::SceneVelocity),
                _target_layer: 0,
                _target_mip_level: 0,
                _clear_value: Some(vulkan_context::get_color_clear_zero()),
            }
