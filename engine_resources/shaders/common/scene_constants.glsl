...
const uint RenderOption_RenderShadow = 1 << 4;
const uint RenderOption_RenderSSAO = 1 << 5;
...
struct VIEW_CONSTANTS
{
    ...
    mat4 INV_CAPTURE_HEIGHT_MAP_VIEW_PROJECTION;
...
struct LIGHT_DATA
{
    ...
    mat4 INV_SHADOW_VIEW_PROJECTION;
    vec3 LIGHT_POSITION;
    int SHADOW_SAMPLES;
