...
impl MouseMoveData {
    ...
    pub fn update_mouse_pos(&mut self, position: &(i32, i32), window_size: &Vector2<i32>, update_mouse_pos: bool) {
    ...
    pub fn update_mouse_move(&mut self, delta: &(i32, i32), window_size: &Vector2<i32>, update_mouse_pos: bool) {
