...
use vulkano::instance::{
    Instance, PhysicalDevice, ApplicationInfo, app_info_from_cargo_toml
};
...
pub struct ApplicationData
    ...
    , _resources: Box<Resources> // Resource.Resources
    }
...
impl ApplicationData {
    ...
    pub fn initialize_application(mut self) {
        ...
        let instance = Instance::new(info, &required_extensions, VULKAN_LAYERS.to_vec()).unwrap();
