...
pub const SWAP_CHAIN_IMAGE_COUNT: u32 = 3;
pub const SWAP_CHAIN_IMAGE_INDICES: [u32; SWAP_CHAIN_IMAGE_COUNT as usize] = [0, 1, 2];
pub const SWAP_CHAIN_IMAGE_FORMAT:vk::Format = vk::Format::B8G8R8A8_SRGB;
pub const SWAP_CHAIN_COLOR_SPACE:vk::ColorSpaceKHR = vk::ColorSpaceKHR::SRGB_NONLINEAR;
pub const MAX_FRAME_COUNT: u32 = 2;
pub const DESCRIPTOR_SET_COUNT_AT_ONCE: u32 = SWAP_CHAIN_IMAGE_COUNT;
