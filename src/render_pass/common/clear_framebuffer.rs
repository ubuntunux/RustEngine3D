...
use crate::vulkan_context::geometry_buffer::{ VertexDataBase, VertexData };
...
pub fn get_framebuffer_data_create_info(renderer_data: &RendererData, framebuffer_name: &str) -> FramebufferDataCreateInfo {
    ...
    match framebuffer_name {
        ...
        "clear_light_probe_depth_1" => render_pass::common::render_forward_for_light_probe::get_framebuffer_data_create_info(renderer_data, 1, light_probe_depth_only),
        "clear_light_probe_depth_2" => render_pass::common::render_forward_for_light_probe::get_framebuffer_data_create_info(renderer_data, 2, light_probe_depth_only),
        "clear_light_probe_depth_3" => render_pass::common::render_forward_for_light_probe::get_framebuffer_data_create_info(renderer_data, 3, light_probe_depth_only),
        "clear_light_probe_depth_4" => render_pass::common::render_forward_for_light_probe::get_framebuffer_data_create_info(renderer_data, 4, light_probe_depth_only),
        "clear_light_probe_depth_5" => render_pass::common::render_forward_for_light_probe::get_framebuffer_data_create_info(renderer_data, 5, light_probe_depth_only),
