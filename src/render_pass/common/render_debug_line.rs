...
use crate::renderer::debug_line::DebugLineVertexData;
...
pub fn get_render_pass_data_create_info(renderer_data: &RendererData) -> RenderPassDataCreateInfo {
    let render_pass_name = String::from("render_debug_line");
    ...
    let pipeline_data_create_infos = vec![
        PipelineDataCreateInfo {
            _pipeline_data_create_info_name: String::from("render_debug_line"),
            _pipeline_vertex_shader_file: PathBuf::from("common/render_debug_line.vert"),
            _pipeline_fragment_shader_file: PathBuf::from("common/render_debug_line.frag"),
            _pipeline_bind_point: vk::PipelineBindPoint::GRAPHICS,
            _pipeline_dynamic_states: vec![vk::DynamicState::VIEWPORT, vk::DynamicState::SCISSOR],
            _pipeline_sample_count: sample_count,
            _pipeline_topology: vk::PrimitiveTopology::LINE_LIST,
            ...
            _vertex_input_bind_descriptions: DebugLineVertexData::get_vertex_input_binding_descriptions(),
            _vertex_input_attribute_descriptions: DebugLineVertexData::create_vertex_input_attribute_descriptions(),
            ...
            _descriptor_data_create_infos: vec![
                ...
                DescriptorDataCreateInfo {
                    ...
                    _descriptor_name: enum_to_string(&ShaderBufferDataType::DebugLineInstanceDataBuffer),
