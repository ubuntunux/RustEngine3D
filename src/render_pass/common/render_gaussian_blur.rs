...
pub fn get_render_pass_data_create_info(renderer_data: &RendererData) -> RenderPassDataCreateInfo {
    ...
    let subpass_dependencies = vec![vk::SubpassDependency {
        ...
        dst_subpass: 0,
        src_stage_mask: vk::PipelineStageFlags::COLOR_ATTACHMENT_OUTPUT, // SceneColor was written as color attachment
        src_access_mask: vk::AccessFlags::COLOR_ATTACHMENT_WRITE, // SceneColor was written to
    ...
    let pipeline_data_create_infos = vec![PipelineDataCreateInfo {
        ...
        _push_constant_data_list: vec![PipelinePushConstantData {
            ...
            _offset: 0,
            _push_constant: Box::new(PushConstant_GaussianBlur::default()),
        }],
