...
pub fn get_render_pass_data_create_info(renderer_data: &RendererData) -> RenderPassDataCreateInfo {
    ...
    let subpass_dependencies = vec![vk::SubpassDependency {
        ...
        dst_subpass: 0,
        src_stage_mask: vk::PipelineStageFlags::COLOR_ATTACHMENT_OUTPUT // For SceneColor, SceneVelocity, TAAResolve (prev)
            | vk::PipelineStageFlags::EARLY_FRAGMENT_TESTS // For SceneDepth
            | vk::PipelineStageFlags::LATE_FRAGMENT_TESTS // For SceneDepth
            | vk::PipelineStageFlags::COMPUTE_SHADER, // For HierarchicalMinZ
        src_access_mask: vk::AccessFlags::COLOR_ATTACHMENT_WRITE // For SceneColor, SceneVelocity, TAAResolve (prev)
            | vk::AccessFlags::DEPTH_STENCIL_ATTACHMENT_WRITE // For SceneDepth
            | vk::AccessFlags::SHADER_WRITE, // For HierarchicalMinZ
