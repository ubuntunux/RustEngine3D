...
pub fn get_render_pass_data_create_infos(renderer_data: &RendererData) -> Vec<RenderPassDataCreateInfo> {
    let mut render_pass_data_create_infos = vec![
        ...
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 0),
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 1),
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 2),
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 3),
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 4),
        common::render_forward_for_light_probe::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal, 5),
        ...
        common::capture_height_map::get_render_pass_data_create_info(renderer_data, RenderObjectType::Skeletal),
