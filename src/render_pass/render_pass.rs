...
use crate::render_pass::{
    common, effect, fft_ocean, precomputed_atmosphere, ray_tracing, render_object,
};
...
pub fn get_render_pass_data_create_infos(
    ...
    let mut render_pass_data_create_infos = vec![
        ...
        common::clear_framebuffer::get_render_pass_data_create_info(
            renderer_data,
    ...
    render_pass_data_create_infos = [
        render_pass_data_create_infos,
        render_object::render_object::get_render_pass_data_create_infos(renderer_data),
    ]
    .concat();
