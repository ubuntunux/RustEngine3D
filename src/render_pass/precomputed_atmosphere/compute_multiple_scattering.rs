...
use crate::vulkan_context::render_pass::{
    ImageAttachmentDescription, PipelineDataCreateInfo, PipelinePushConstantData, RenderPassDataCreateInfo,
};
...
use crate::scene::precomputed_atmosphere::{DEFAULT_USE_COMBINED_TEXTURES, PushConstant_PrecomputedAtmosphere};

pub fn get_framebuffer_data_create_info(renderer_data: &RendererData) -> FramebufferDataCreateInfo {
    let render_target0 =
        renderer_data.get_render_target(RenderTargetType::PRECOMPUTED_ATMOSPHERE_DELTA_RAYLEIGH_SCATTERING); // equal to DELTA_MULTIPLE_SCATTERING_TEXTURE
    let render_target1 = renderer_data.get_render_target(RenderTargetType::PRECOMPUTED_ATMOSPHERE_SCATTERING);
