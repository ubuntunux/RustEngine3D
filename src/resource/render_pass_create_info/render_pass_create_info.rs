...
pub fn get_render_pass_data_create_infos(renderer_data: &RendererData) -> Vec<RenderPassDataCreateInfo> {
    vec![
        ...
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_0"),
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_1"),
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_2"),
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_3"),
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_4"),
        clear_framebuffer::get_render_pass_data_create_info(renderer_data, "clear_light_probe_5"),
