...
impl TextRenderData {
    ...
    pub fn create_texture_render_data_descriptor_sets(&mut self, device: &Device, resources: &Resources) {
        let material_instance = resources.get_material_instance_data("system/ui/render_font").borrow();
...
impl FontManager {
    ...
    pub fn render_text(
        ...
        if self._show && 0 < self._logs.len() {
            ...
            let material_instance_data = resources.get_material_instance_data("system/ui/render_font").borrow();
